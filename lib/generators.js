...
const SECTION_PLAN = {
  ...
  drop:  { stems: ['kick', 'snare', 'hats', 'perc', 'sub', 'bass', 'chords', 'arp', 'lead', 'guide', 'fx'], energy: 1.0 },
  break: { stems: ['pads', 'chords', 'lead', 'guide', 'perc', 'sub'], energy: 0.72, thin: { perc: 0.4, guide: 0.65 } },
...
const STEM_NAMES = {
  ...
  arp: 'Arp', lead: 'Lead', guide: 'Piano Hook Guide', counter: 'Counter', fx: 'FX',
};
...
export function generate({
  ...
  materials.guide = makePianoGuide(materials.lead);
